...
x = int(input("Запишите ид вашего микрофона сюда: "))
os.system("pause")
m = sr.Microphone(device_index = x)

root = Tk()
text = Text(width=50, height=10)
frames = [PhotoImage(file="Test Data/viki.gif", format='gif -index %i' %i) for i in range(37)]
def update(ind):
    frame = frames[ind]
    ind += 1
